...
public class DepartmentController {
	...
	public ResponseEntity<List<Department>> getDepartments() {
		...
		return new ResponseEntity<List<Department>>(listDepartment, OK);
			...
			return new ResponseEntity<List<Department>>(listDepartment, NOT_FOUND);
		}		
	}

	@ApiOperation(value = "Add department")
	@ApiResponses(value = {
			@ApiResponse(code = DepartmentConstants.SUCCESS_CODE, message = DepartmentConstants.DEP_ADD_SCUCCESS_MESSAGE),
	...
	@ApiResponses(value = {
			@ApiResponse(code = DepartmentConstants.SUCCESS_CODE, message = DepartmentConstants.DEP_EDIT_SCUCCESS_MESSAGE),
	...
	public ResponseEntity<Department> getDepartment(@RequestParam("id") int id) {
